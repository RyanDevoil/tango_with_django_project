    ...
    if request.method == 'POST':
        ...
        if user:
            if user.is_active:
                ...
                return render(request, 'rango/login.html', {'errormessage':'Your account has been disabled.'})
        else:
            print("Invalid login details: {0}, {1}".format(username, password))
            return render(request, 'rango/login.html', {'errormessage': 'Invalid username or password.'})
    else:
